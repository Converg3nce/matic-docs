...
- For a test run to confirm if the correct remote machine / VM is configured, run the following command:
    ...
    ```js
    ansible-playbook -l sentry playbooks/network.yml --extra-var="bor_branch=v0.2.4 heimdall_branch=v0.2.0-mumbai-42a1beac network_version=testnet-v4 node_type=sentry/sentry" --list-hosts
    ```
...
- Setup the full node with this command:
    ...
    ```js
    ansible-playbook -l sentry playbooks/network.yml --extra-var="bor_branch=v0.2.4 heimdall_branch=v0.2.0-mumbai-42a1beac network_version=testnet-v4 node_type=sentry/sentry"
    ```
